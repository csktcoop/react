        ...
        <div className="flex">
            ...
            <main className=" p-4">
                ...
                <section>
                    <MyButton />
                    <h2>H2 section</h2>
                    <p>Brief Paragraph with <mark>highlight</mark></p>
                </section>
                ...
                <article>
                    ...
                    <p>Paragraph with <time dateTime="2008-02-14 20:00">Valentines day</time></p>
                    <Box width={256}>
                    <Card
                        p={1}
                        borderRadius={2}
                ...
                <details>
                    ...
                    <p>user can view or hide the details</p>
